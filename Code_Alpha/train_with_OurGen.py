...
''' Partila Trined Model '''
if PARTIAL_TRAIN :
	weight_path = r'C:\Machinelearning\cameraModel\models\weights_sgd_28_12_2017_. 14-2.241.hdf5';
	resnet_object.Model.load_weights(weight_path); #load_model('path_to_model);
	print('Model Loded from Pre_trained Weights!');
 
''' Compile Model'''
#sgd = optimizers.SGD(lr=0.1, decay=1e-6, momentum=0.9, nesterov=False) # this was for first 15 Epoch of training.
...
''' Checkpoints '''
checkpoint = ModelCheckpoint('./models/weights_sgd__Loaded_Weight_29_12_2017_.{epoch:3d}-{loss:.3f}.hdf5');
...
history2 = resnet_object.Model.fit_generator(train_dir_generator,
					...
					verbose=1)
resnet_object.Model.save('./camera_model_DataAug_SGD_Resnet18_Loaded_Weight_28_12_2017.h5');